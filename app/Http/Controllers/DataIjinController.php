...
class DataIjinController extends Controller
{
    ...
    public function index()
    {
        ...
        $data_ijins = $data_ijins->orderBy('from_date', 'desc')->paginate(10);

        $data = [
            'data_ijins' => $data_ijins,
        ];

        return view('data_ijin.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('data_ijin.create', $data);
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $data_ijin->from_date   = $from->toDateString();
            $data_ijin->to_date     = $to->toDateString();
