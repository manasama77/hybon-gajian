...
class PeriodeCutoffController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('periode_cutoff.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('periode_cutoff.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('periode-cutoff.index')->with('success', 'Periode Cutoff berhasil ditambahkan');
    }
    ...
    public function edit(PeriodeCutoff $periodeCutoff)
    {
        ...
        return view('periode_cutoff.edit', $data);
    }
    ...
    public function update(Request $request, PeriodeCutoff $periodeCutoff)
    {
        ...
        return redirect()->route('periode-cutoff.index')->with('success', 'Periode Cutoff berhasil diubah');
    }
    ...
    public function destroy(PeriodeCutoff $periodeCutoff)
    {
        ...
        return redirect()->route('periode-cutoff.index')->with('success', 'Periode Cutoff berhasil dihapus');
    }
