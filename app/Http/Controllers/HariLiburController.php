...
class HariLiburController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $hari_liburs = $hari_liburs->paginate(10);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('hari-libur.index')->with('success', 'Hari Libur created successfully !');
    }
    ...
    public function update(Request $request, HariLibur $hari_libur)
    {
        ...
        return redirect()->route('hari-libur.index')->with('success', 'Hari libur updated successfully !');
    }
    ...
    public function destroy(HariLibur $hari_libur)
    {
        ...
        try {
            ...
            return redirect()->route('hari-libur.index')->with('success', 'Hari libur deleted successfully !');
        } catch (\Exception $e) {
            \DB::rollBack();
            return redirect()->route('hari-libur.index')->with('error', 'Failed to delete Hari libur: ' . $e->getMessage());
        }
    }
}
