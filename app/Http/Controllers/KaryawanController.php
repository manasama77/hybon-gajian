...
class KaryawanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $karyawans = $karyawans->with('user')->paginate(10);
    ...
    public function create()
    {
        ...
        return view('karyawan.create', compact('departements'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::rollBack();
            return redirect()->route('karyawan.index')->withError($e->getMessage())->withInput();
        }
    }
    ...
    {
        $departements = Departement::all();
        return view('karyawan.edit', compact('karyawan', 'departements'));
    }
    ...
    {
        $departements = Departement::all();
        return view('karyawan.reset_password', compact('karyawan', 'departements'));
    }
    ...
    public function reset_password_process(Request $request, Karyawan $karyawan)
    {
        ...
        return redirect()->route('karyawan.index')->with('success', 'Reset password successfully !');
    }
}
