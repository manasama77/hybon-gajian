                            ...
                            <tbody>
                                ...
                                @foreach ($periode_cutoffs as $periode_cutoff)
                                    <tr
                                        class="dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 bg-white border-b">
                                        <td class="px-6 py-4">
                                            {{ $periode_cutoff->kehadiran_start->format('d M Y') }}
                                        </td>
                                        <td class="px-6 py-4">
                                            {{ $periode_cutoff->kehadiran_end->format('d M Y') }}
                                        </td>
                                        <td class="px-6 py-4">
                                            {{ $periode_cutoff->lembur_start->format('d M Y') }}
                                        </td>
                                        <td class="px-6 py-4">
                                            {{ $periode_cutoff->lembur_end->format('d M Y') }}
                                        </td>
                                        <td class="px-6 py-4">
