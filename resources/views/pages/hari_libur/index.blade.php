<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="">
                <a href="{{ route('setup.hari-libur.create') }}"
            ...
            <div class="dark:bg-gray-800 sm:rounded-lg overflow-hidden bg-white shadow-sm">
                <div class="dark:text-gray-100 p-6 text-gray-900">
                    ...
                    <div class="flex items-center justify-end mb-4">
                        <form action="{{ route('setup.hari-libur.index') }}" method="GET" class="md:max-w-sm w-full">
                            <div class="flex">
                                <input type="text" name="search" placeholder="Cari Hari Libur"
                            ...
                            <tbody>
                                ...
                                @foreach ($hari_liburs as $hari_libur)
                                    <tr
                                        class="dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 bg-white border-b">
                                        <td class="px-6 py-4">
                                            {{ $hari_libur->tanggal->format('d F Y') }}
                                        </td>
                                        <td class="px-6 py-4">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            ...
                                            <div class="flex flex-wrap justify-center gap-3">
                                                <a href="{{ route('setup.hari-libur.edit', $hari_libur) }}"
                                                ...
                                                <form id="delete-form-{{ $hari_libur->id }}"
                                                    action="{{ route('setup.hari-libur.destroy', $hari_libur) }}"
                                                    method="POST" class="inline">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                                <button type="button"
                                                    onclick="askDelete('delete-form-{{ $hari_libur->id }}')"
