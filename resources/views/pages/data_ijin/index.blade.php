                                                ...
                                                <div class="flex gap-2">
                                                    @if ($data_ijin->lampiran)
                                                        <div>
                                                            <a href="{{ route('data-ijin.download', $data_ijin->id) }}"
                                                                class="focus:outline-none hover:bg-yellow-600 focus:ring-4 focus:ring-yellow-300 dark:focus:ring-yellow-900 px-3 py-2 text-sm font-medium text-white bg-yellow-500 rounded-lg"
                                                                target="_blank">
                                                    ...
                                                    <div>
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            class="focus:outline-none hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 px-3 py-2 text-sm font-medium text-white bg-red-700 rounded-lg">
