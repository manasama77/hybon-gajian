                ...
                <form action="{{ route('setup.karyawan.update', $karyawan) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="no_rekening" id="no_rekening"
                            ...
                            value="{{ $karyawan->no_rekening }}" required />
                        @error('no_rekening')
                            <p class="text-xs italic text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        <label for="is_active" class="dark:text-white block mb-2 text-sm font-medium text-gray-900">
                            Status
                        </label>
                        <select id="is_active" name="is_active"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            required>
                            <option @selected($karyawan->is_active == true) value="1">Aktif</option>
                            <option @selected($karyawan->is_active == false) value="0">Tidak Aktif</option>
                        </select>
                        @error('is_active')
                            <p class="text-xs italic text-red-500">{{ $message }}</p>
                        @enderror
