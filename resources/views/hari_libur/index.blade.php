            ...
            <div class="dark:bg-gray-800 sm:rounded-lg overflow-hidden bg-white shadow-sm">
                <div class="dark:text-gray-100 p-6 text-gray-900">
                    ...
                    <div class="flex items-center justify-end mb-4">
                        <form action="{{ route('hari-libur.index') }}" method="GET" class="md:max-w-sm w-full">
                            <div class="flex">
                                    ...
                                    <tr
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            ...
                                            <div class="flex flex-wrap justify-center gap-3">
                                                <a href="{{ route('hari-libur.edit', $hari_libur) }}"
                                                ...
                                                <form id="delete-form-{{ $hari_libur->id }}"
                                                    action="{{ route('hari-libur.destroy', $hari_libur) }}"
